...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1548: (o, p) => p in o,
      _1549: (o, p) => o[p],
      _1552: () => new XMLHttpRequest(),
      _1553: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _1555: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
      ...
      _1577: (x0,x1) => new WebSocket(x0,x1),
      _1578: (x0,x1) => x0.send(x1),
      _1579: (x0,x1,x2) => x0.close(x1,x2),
      _1580: (x0,x1) => x0.close(x1),
      _1581: x0 => x0.close(),
      ...
      _2716: x0 => x0.files,
      _2740: (x0,x1) => { x0.multiple = x1 },
      _2758: (x0,x1) => { x0.type = x1 },
      _3390: x0 => x0.files,
      _3401: x0 => x0.dataTransfer,
      _3405: () => globalThis.window,
      _3462: x0 => x0.location,
      _3463: x0 => x0.history,
      _3740: x0 => x0.localStorage,
      _3748: (x0,x1) => { x0.href = x1 },
      _4011: x0 => x0.data,
      _4172: x0 => x0.length,
